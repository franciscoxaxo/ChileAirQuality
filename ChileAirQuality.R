...
ChileAirQuality<-function(Comunas, Contaminantes, input_fecha_inicio, input_fecha_termino){
  city<-c("SA", "CE1", "CE", "CN","EB", "IN","LF","LC","PU","PA","QU","QU1")
  code_city<-c("RM/D14","RM/D16","RM/D31","RM/D18","RM/D17","RM/D11","RM/D12","RM/D13","RM/D15","RM/D27","RM/D30","RM/D19")
  ...
  nombre_city<-c("Parque O'Higgins","Cerrillos 1", "Cerrillos", "Cerro Navia", "El Bosque","Independecia","La Florida","Las Condes","Pudahuel","Puente Alto","Quilicura","Quilicura 1")
  ...
  j<-NULL; i<-NULL;aux_1<-NULL;aux_2<-NULL;aux_3<-NULL; aux_4<-NULL;aux_5<-NULL;
